...
public interface PayChannelService {
     ...
     * @throws BusinessException
     */
    List<PayChannelDTO> findPayChannelByPlatformChannel(String platformChannelCode) throws BusinessException;
     ...
     * @return
     */
    List<PayChannelParamDTO> findPayChannelParamList(String appId, String platformChannel);

    /**
     * 根据应用、服务类型和支付渠道查询该支付渠道的参数配置信息
     *
     * @param appId           应用id
     * @param platformChannel 服务类型code
     ...
     * @return
     */
    PayChannelParamDTO findPayChannelParam(String appId, String platformChannel, String payChannel);
